...
public class DataService extends HoldRunApplication {
    ...
    private final ConcurrentHashMap<String, ChatRoom> roomMap = new java.util.concurrent.ConcurrentHashMap<>();
